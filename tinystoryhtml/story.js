...
storyArray[1] = "<p> This is choice 1 </p> "; 
  choiceArray[2] = ""; 
  choiceArray[2] += "<input class='block button' type='button' value='Choose the wrong path! ' onClick='javascript:swap(4);' />";
storyArray[2] = "<p> This is choice 2 </p> "; 
  choiceArray[3] = "";
storyArray[3] = "<p> And this is the end. You live happilly evar after. </p> "; 
  choiceArray[4] = "";
storyArray[4] = "<p> BOOM! YOU DEAD! NO BIG SURPRISE! </p> "; 
  choiceArray[4] = "";